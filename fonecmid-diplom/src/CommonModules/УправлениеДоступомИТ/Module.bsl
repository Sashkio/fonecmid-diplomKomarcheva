...
Процедура ПриЗаполненииПоставляемыхПрофилейГруппДоступа(ОписанияПрофилей, ПараметрыОбновления) Экспорт
	...
	//специалист 
	УИДПрофиля1 = Новый УникальныйИдентификатор();
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "Специалист";
	ОписаниеПрофиля.Идентификатор = УИДПрофиля1;
	...
	//менеджер 
	УИДПрофиля2 = Новый УникальныйИдентификатор();
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "Менеджер";
	ОписаниеПрофиля.Идентификатор = УИДПрофиля2;
	...
	//Бухгалтер
	УИДПрофиля3 = Новый УникальныйИдентификатор();
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "Бухгалтер";
	ОписаниеПрофиля.Идентификатор = УИДПрофиля3;
	...
	//Кадровик
	УИДПрофиля4 = Новый УникальныйИдентификатор();
	
	ОписаниеПрофиля = УправлениеДоступом.НовоеОписаниеПрофиляГруппДоступа();
	ОписаниеПрофиля.Имя = "КадровикРасчетчик";
	ОписаниеПрофиля.Идентификатор = УИДПрофиля4;
